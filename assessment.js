...
function sum(addedToSelf){
  addedToSelf + addedToSelf
  return addedToSelf
}
// CODE HERE
...
function greeter(aName,aNum){
  return 'Hi! I am ' + aName + ' and I am ' + aNum + " years old"  
